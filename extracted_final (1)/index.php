...
<head>
    ...
    <link rel="stylesheet" href="stylesync.css">
...
<div class="Admin">
    <nav class="navbar navbar-expand-lg navbar-dark custom-navbar">
        ...
        <div class="Content">
            <div class="text">
                <h1>Achieve Brilliance!</h1>
                <p>Book your appointment now to attain the hair transformation of your dreams!</p>
            </div>
        </div>

        <div class="Content2">
            <div class="text2">
                <h1>Secure your slot now for <br> a fabulous hair makeover!</h1>
