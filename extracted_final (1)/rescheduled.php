...
// Default SQL query to fetch pending appointments
...
if (isset($_GET['search'])) {
    ...
    $sql .= "AND (s.Sname LIKE '%$search%' OR u.Fname LIKE '%$search%' OR u.Lname LIKE '%$search%' 
                 ...
                 OR a.total_payment LIKE '%$search%') ";
}
                    ...
                    <ul class="navbar-nav ms-auto me-0">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item active" href="rescheduled.php">Rescheduled Appointments</a></li>
      ...
      <form method="GET">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <?php if ($user_type == 'client' && $row['status'] == 'rescheduled'): ?>
