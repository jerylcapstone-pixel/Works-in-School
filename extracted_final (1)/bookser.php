...
<body>
    ...
    <div class="container mt-4">
        <div class="card card-container">
            <div class="card-header">
                <h2 class="card-title">Book Service: <?php echo htmlspecialchars($service['Sname']); ?></h2>
            </div>
            <div class="card-body">
                <form action="book.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="service_name" name="service_name" value="<?php echo htmlspecialchars($service['Sname']); ?>" disabled>
                    </div>
                    <div class="form-group">
                        <label for="service_description">Service Description:</label>
                        <textarea class="form-control" id="service_description" name="service_description" rows="3" disabled><?php echo htmlspecialchars($service['description']); ?></textarea>
                    </div>
                    <div class="form-group">
                        <label for="service_fee">Service Fee (₱)</label>
                       <input type="number" step="0.01" class="form-control" id="service_fee" name="service_fee" value="<?php echo htmlspecialchars($service['Sfee']); ?>" disabled>
                    </div>
                  <div class="form-group">
    ...
    <input type="datetime-local" class="form-control" id="date" name="date" min="<?php echo date('Y-m-d\TH:i'); ?>" required>
                    ...
                    <!-- Additional field for hair color -->
                    ...
                    <!-- Additional field for hairstyle -->
                    <div id="hairstyle_input" style="display: none;">
                        <div class="form-group">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            var hairstyle_input = document.getElementById("hairstyle_input");

            if (service_id == 3) {
                hairstyle_input.style.display = "block";
            }
